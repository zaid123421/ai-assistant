...
def ask(query, vector_store):
    ...
    prompt = f"""You are an assistant that answers ONLY based on the provided context. Do not use external knowledge.
If the context does not contain enough information to answer the question, say "I cannot find this information in the provided documents."
When the question asks for a list (e.g. skills, experience, items), include ALL items from the context—do not omit or summarize any.
...
if __name__ == "__main__":
    ...
    # Fresh index every run (avoids stale / duplicated vectors in chroma_db)
